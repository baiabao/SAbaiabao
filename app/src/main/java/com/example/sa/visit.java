...
public class visit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String choose = bundle0311.getString("division");
        //抓到設定的textview
        setTextView();
                        ...
                        try {
                            ...
                            while (j < qua)
                            {
                                ...
                                if(division.equals(choose)){
                                    //丟入此方法 print中
                                    print(week, time, date, doctor_name);
                                }
    ...
    public void print(int week,int time,String date,String dn)
    {
        ...
        if (week == 1) {
            Mon.setText(date1+"\n週一");
            if (time == 0){
                createButton(dn,Mon0);
            }

            else if (time == 1)
                createButton(dn,Mon1);
            else
                createButton(dn,Mon2);
        }
        else if (week == 2) {
            Tue.setText(date1+"\n週二");
            if (time == 0)
                createButton(dn,Tue0);
            else if (time == 1)
                createButton(dn,Tue1);
            else
                createButton(dn,Tue2);
        }
        else if (week == 3) {
            Wed.setText(date1+"\n週三");
            if (time == 0)
                createButton(dn,Wed0);
            else if (time == 1)
                createButton(dn,Wed1);
            else{
                createButton(dn,Wed2);
            ...
            Thu.setText(date1+"\n週四");
            if (time == 0)
                createButton(dn,Thu0);
            else if (time == 1)
                createButton(dn,Thu1);
            else
                createButton(dn,Thu2);
        }
        else if (week == 5) {
            Fri.setText(date1+"\n週五");
            if (time == 0){
                createButton(dn,Fri0);
            }
            else if (time == 1){
              createButton(dn,Fri1);
            }
            else{
                createButton(dn,Fri2);
...
//        Fri2 = findViewById(R.id.Fri2);
    ...
    private void createButton(String txt, LinearLayout view) {
